...
const RefBanksDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10} rowClassName="cursor-pointer">
            ...
            <Column field="abbr" header="Abbr" body={pTemplate1} style={{ minWidth: "8rem" }} />
...
export default RefBanksDataTable;