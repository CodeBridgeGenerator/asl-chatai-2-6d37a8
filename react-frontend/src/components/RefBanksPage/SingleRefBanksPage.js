...
const SingleRefBanksPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("refBanks")
            .get(urlParams.singleRefBanksId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    }, [props,urlParams.singleRefBanksId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">RefBanks</h3>
                </div>
                <p>refBanks/{urlParams.singleRefBanksId}</p>
...
export default connect(mapState, mapDispatch)(SingleRefBanksPage);
