...
const PromptsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const tickTemplate15 = (rowData, { rowIndex }) => <i className={`pi ${rowData.status?"pi-check": "pi-times"}`}  ></i>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10} rowClassName="cursor-pointer">
            ...
            <Column field="chataiid" header="ChatAi" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
            <Column field="configid" header="Config" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
