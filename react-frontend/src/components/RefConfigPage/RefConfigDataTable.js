...
const RefConfigDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10} rowClassName="cursor-pointer">
            <Column field="chatAiId" header="ChatAi" body={pTemplate0} sortable style={{ minWidth: "8rem" }} />
            ...
            <Column field="bedrockModelId" header="Bedrock Model Id" body={pTemplate3} style={{ minWidth: "8rem" }} />
